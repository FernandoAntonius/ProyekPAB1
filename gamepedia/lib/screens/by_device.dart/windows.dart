...
class WindowsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final windowsDevice = gameList
        .where(
          (game) => game.device.any((g) => g.toLowerCase().contains('windows')),
        )
        .toList();
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: windowsDevice.isEmpty
              ...
              : ListView.builder(
                  itemCount: windowsDevice.length,
                  itemBuilder: (context, index) {
                    final game = windowsDevice[index];
