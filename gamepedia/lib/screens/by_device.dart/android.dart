...
class AndroidScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final androidDevice = gameList
        .where(
          (game) => game.device.any((g) => g.toLowerCase().contains('android')),
        )
        .toList();
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: androidDevice.isEmpty
              ...
              : ListView.builder(
                  itemCount: androidDevice.length,
                  itemBuilder: (context, index) {
                    final game = androidDevice[index];
