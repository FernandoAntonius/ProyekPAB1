...
class AdventureScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final adventureGames = gameList
        .where(
          (game) => game.genre.any((g) => g.toLowerCase().contains('adventure')),
        )
        .toList();
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: adventureGames.isEmpty
              ...
              : ListView.builder(
                  itemCount: adventureGames.length,
                  itemBuilder: (context, index) {
                    final game = adventureGames[index];
