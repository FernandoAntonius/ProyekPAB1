...
class StrategyScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final strategyGames = gameList
        .where(
          (game) => game.genre.any((g) => g.toLowerCase().contains('strategy')),
        )
        .toList();
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: strategyGames.isEmpty
              ...
              : ListView.builder(
                  itemCount: strategyGames.length,
                  itemBuilder: (context, index) {
                    final game = strategyGames[index];
